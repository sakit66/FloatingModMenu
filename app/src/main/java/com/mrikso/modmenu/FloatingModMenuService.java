...
public class FloatingModMenuService extends Service {
   ...
   // private native String toastFromJNI();
    ...
    private void initFloating() {
        ...
        rootFrame = new FrameLayout(getBaseContext()); //глобальная разметка
        mRootContainer = new RelativeLayout(getBaseContext());//разметка на которую будут помещены две разметки иконки и самого меню
    ...
    private void initMenuButton(final View collapsedView, final View expandedView) {
        ...
        seek_icon.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                float value = getConvertetValue(progress);
                curent_icon = value;
